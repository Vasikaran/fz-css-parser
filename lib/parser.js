...
var cssParser = function () {
    ...
    _createClass(cssParser, [{
        ...
        value: function getValue(selector) {
            var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { isClass: true };
            ...
            var value = this.ast[selector];
            if (value) {
                var raw = this.getRaw(selector, value);
                var medias = this.getMedia(selector);
                var keyframes = this.getKeyFrames(selector);
        ...
        value: function getCommon() {
            ...
            selectors.forEach(function (selector) {
                var raw = _this5.getRaw(selector, commons[selector]);
