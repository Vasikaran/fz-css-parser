...
var formator = function formator(css) {
    var parseSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    var alignCamelCase = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    lines.forEach(function (line) {
        if (!(0, _utils.isUnwantedLine)(line)) {
            if (((0, _utils.hasMediaQuery)(line) || isMedia) && !isKeyFrame) {
                ...
                var result = (0, _mediaQueryFormator2.default)(line, parseSelector);
                if (result) {
                ...
                var _result = (0, _keyFrameFormator2.default)(line, parseSelector);
                if (_result) {
                    var _key = _result.key,
                        object = _result.object;

                    formatedObj['__keyFrames_'][_key] = object[_key];
                    isKeyFrame = false;
                }
                ...
                keys.forEach(function (cName) {
                    if ((0, _utils.isStyle)(cName) && alignCamelCase) {
                        cName = (0, _utils.classNameFilter)(cName);
                    }
                    if (styleObj['-webkit-animation-name']) {
                        var _getSelector = (0, _utils.getSelector)(cName),
                            _getSelector2 = _slicedToArray(_getSelector, 1),
                            name = _getSelector2[0];

                        var val = styleObj['-webkit-animation-name'];
                    ...
                    formatedObj = (0, _utils.updateCss)(formatedObj, cName, styleObj, undefined, parseSelector);
                });
                key = '';
                style = '';
            } else {
